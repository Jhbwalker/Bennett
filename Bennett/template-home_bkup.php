...
<div class="container" id="parentdiv">
    <div class="full-w">
        ...
        <div class="animated fadeInDown" id="inline-email" style="width:600px;padding:20px;position:fixed; background-color: rgba(0,0,0,0.95);top:175px;left:calc(50% - 300px); opacity: 70%; ">
          <!--<h2 class="bm-large tm-large">ENJOY <span style="color:red;">20%</span> ON YOUR FIRST ONLINE ORDER</h2>-->
                    ...
                    <span id="closex" class="pull-right"style="float: right; " data-tooltip="Close" original-title=""><i style="cursor:pointer;font-size:25px;" class="fa fa-times-circle"></i></span>
                     <p class="toWhite" stlye="font-family: 'Montserrat', sans-sarif;"> Sign Up to our Newsletter to Receive the Latest Insider News. </p>
        ...
        <div class="mc-field-group size1of2">
            ...
            <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_8c8f3b390e034f221986dcd61_95aaab481b" tabindex="-1" value=""></div>
            <center> <div class="clear"><button type="button" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" style="background-color:orange; color:black;
